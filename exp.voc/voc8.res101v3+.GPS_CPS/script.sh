...
export volna="/home/GPS_semiseg/DATA/"
export NGPUS=8
export OUTPUT_PATH="/home/GPS_semiseg/log/ss6/"
export snapshot_dir=$OUTPUT_PATH

export batch_size=8
export learning_rate=0.00125 #0.00125 
export snapshot_iter=1

# python -m torch.distributed.launch --nproc_per_node=$NGPUS train_ss.py
