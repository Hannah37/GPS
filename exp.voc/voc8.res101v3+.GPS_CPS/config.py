...
load_pretrain_dir = 'save/res101_pre_8.pt'
save_t_dir = 'save/aug2_t_res101_8.pt'
save_b1_dir = 'save/aug2_b1_res101_8.pt'
save_b2_dir = 'save/aug2_b2_res101_8.pt'

remoteip = os.popen('pwd').read()
if os.getenv('volna') is not None:
    C.volna = os.environ['volna']
else:
    C.volna = "/home/GPS_semiseg/"#/DATA/pascal_voc"
...
if os.getenv('snapshot_dir'): # OUTPUT_PATH
